...
async function generateCommitMessage(changedFiles, codeDiff, detailedChanges, oldVersion, newVersion) {
    ...
    if (!apiKey) {
        ...
        return `Hollingshead Harbor Release: v${newVersion}`;
    }
...
IMPORTANT RULES:
- First line MUST be exactly: "Hollingshead Harbor Release: v${newVersion}"
...
async function main() {
    ...
    console.log(`\nHollingshead Harbor Release ${newVersion} complete!`);
}
