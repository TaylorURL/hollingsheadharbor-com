          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5 lg:sticky lg:top-32 scroll-animate-left">
              ...
              <h2 className="text-5xl md:text-6xl font-black text-gray-900 leading-[1.1] mb-6">
                We Move<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-blue-600">What Matters</span>
              </h2>
              ...
              <div className="flex items-center gap-6">
                <div className="flex -space-x-3">
                  <div className="w-12 h-12 rounded-full bg-blue-800 border-4 border-white flex items-center justify-center text-white font-bold text-sm">AL</div>
                  <div className="w-12 h-12 rounded-full bg-red-600 border-4 border-white flex items-center justify-center text-white font-bold text-sm">FL</div>
                  <div className="w-12 h-12 rounded-full bg-blue-800 border-4 border-white flex items-center justify-center text-white font-bold text-sm">MI</div>
                  <div className="w-12 h-12 rounded-full bg-red-600 border-4 border-white flex items-center justify-center text-white font-bold text-sm">TN</div>
                  <div className="w-12 h-12 rounded-full bg-blue-800 border-4 border-white flex items-center justify-center text-white font-bold text-sm">TX</div>
                </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="group relative bg-gradient-to-br from-blue-800 to-blue-900 rounded-3xl p-8 text-white overflow-hidden scroll-animate stagger-1 hover:scale-[1.02] transition-transform duration-500">
                ...
                <div className="relative">
                  ...
                  <p className="text-blue-100 leading-relaxed">On-time delivery and professional maritime logistics you can count on, backed by decades of industry experience.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group bg-white rounded-3xl p-8 border-2 border-gray-100 hover:border-red-600 transition-colors duration-300 scroll-animate stagger-2">
                  ...
                  <p className="text-gray-500 text-sm">Custom shipping plans tailored to your schedule.</p>
                </div>
                ...
                <div className="group bg-white rounded-3xl p-8 border-2 border-gray-100 hover:border-blue-800 transition-colors duration-300 scroll-animate stagger-3">
                  <div className="w-14 h-14 bg-blue-800/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-800 transition-colors">
                    <svg className="w-7 h-7 text-blue-800 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Expert Team</h3>
                  <p className="text-gray-500 text-sm">Skilled maritime professionals at your service.</p>
                </div>
              </div>
