...
function Services() {
  ...
  return (
    <div>
      <HeroSection
        title="Our Services"
        subtitle="Marine transportation and logistics solutions"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mb-20">
            <div className="lg:col-span-5 lg:sticky lg:top-32 scroll-animate-left">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-sm font-medium">Bulk Cargo</span>
                <span className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-sm font-medium">Vessel Hire</span>
                <span className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-sm font-medium">Barge Charter</span>
                <span className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-sm font-medium">Logistics</span>
              </div>
            </div>
            ...
            <div className="lg:col-span-7">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {services.map((service, index) => (
                  <div key={service.id} className={`scroll-animate stagger-${(index % 4) + 1} ${index === 0 ? 'md:col-span-2' : ''}`}>
          ...
          <div className="relative bg-gray-50 rounded-[3rem] p-12 md:p-20 overflow-hidden scroll-animate">
            ...
            <div className="relative text-center">
              ...
              <p className="text-gray-500 text-lg max-w-2xl mx-auto mb-10">
                Connect with our team to discuss your shipping requirements and get a customized quote.
              </p>
