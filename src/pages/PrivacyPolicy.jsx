            ...
            <div className="scroll-animate">
              ...
              <ul className="space-y-3 text-gray-600 mb-12">
                <li className="flex items-start">
                  ...
                  <span>What personally identifiable information is collected from you through the website, how it is used and with whom it may be shared.</span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-red-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-red-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span>The security procedures in place to protect the misuse of your information.</span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-red-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <div className="scroll-animate">
              <div className="bg-gray-50 rounded-2xl p-8 mb-12">
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <p>
                    Information collected through the form, including phone numbers, is used solely for the purpose 
                    of responding to inquiries. If you provide a mobile phone number, you consent to receive SMS text 
                    messages related to your inquiry. We do not retain or store this information beyond the completion 
                    of your request and do not use it for any other purpose unless specified. We ensure compliance 
                    with all relevant regulations regarding SMS communication and user consent.
                  </p>
                  <p>
            ...
            <div className="scroll-animate">
              <div className="bg-blue-800 rounded-2xl p-8 mb-12 text-white">
                ...
                <div className="space-y-4 text-blue-100">
                  ...
                  <p>
                    This includes SMS messages for conversations (external), conversations (between employees). 
              ...
              <div className="bg-gray-50 rounded-2xl p-8 mb-12">
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <p>
                    ...
                    icon in the address bar and looking for "https" at the beginning of the address of the Web page.
                  </p>
                  <p>
                    ...
                    information. The computers/servers in which we store personally identifiable information 
