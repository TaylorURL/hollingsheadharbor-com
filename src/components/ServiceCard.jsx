        ...
        return (
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              strokeWidth={1.5}
              d="M3 17h18M3 17l2-9h14l2 9M5 8V6a2 2 0 012-2h10a2 2 0 012 2v2M12 4v4M8 8h8"
            />
          </svg>
        );
      case 'Vessel Icon':
        return (
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={1.5}
              d="M12 19l9-5-9-5-9 5 9 5zM12 19v-4M3 14v4l9 5 9-5v-4"
            />
          </svg>
        );
      case 'Barge Icon':
        return (
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={1.5}
              d="M4 16h16M4 16l1-6h14l1 6M6 10V8h12v2M8 8V6h8v2M3 20h18"
            />
          </svg>
        );
      case 'Logistics Icon':
  ...
  return (
    <div className="group relative bg-white rounded-3xl overflow-hidden border-2 border-gray-100 hover:border-transparent transition-all duration-500 hover:shadow-2xl">
      ...
      <div className="relative p-8">
        ...
        <p className="text-gray-500 group-hover:text-blue-100 leading-relaxed transition-colors duration-500">
          {service.description}
        </p>
        <a
