export const SALES_REP_URL = 'https://www.smyrnareadymix.com/customers/sales-rep';
export const MAIN_WEBSITE_URL = 'https://www.smyrnareadymix.com';
export const PHONE_NUMBER = '6153551028';
export const PHONE_DISPLAY = '(615) 355-1028';
...
export const CAREERS_URL = 'https://www.smyrnareadymix.com/careers';
